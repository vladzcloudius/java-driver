...
public class LocalTimeCodec extends TypeCodec<java.time.LocalTime> {
  ...
  @Override
  public ByteBuffer serialize(java.time.LocalTime value, ProtocolVersion protocolVersion)
  ...
  @Override
  public java.time.LocalTime deserialize(ByteBuffer bytes, ProtocolVersion protocolVersion)
      throws InvalidTypeException {
