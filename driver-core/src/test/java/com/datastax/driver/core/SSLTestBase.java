...
public abstract class SSLTestBase extends CCMTestsSupport {
   ...
   * @throws Exception A {@link com.datastax.driver.core.exceptions.NoHostAvailableException} will
   *     be raised here if connection cannot be established.
   */
  ...
  protected void connectWithSSL() throws Exception {
    Cluster cluster = register(createClusterBuilder().withSSL().build());
    cluster.connect();
  }
