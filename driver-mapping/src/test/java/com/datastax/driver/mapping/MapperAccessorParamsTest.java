...
public class MapperAccessorParamsTest extends CCMTestsSupport {
  ...
  public void should_fail_if_not_enough_parameters() {
    new MappingManager(session()).createAccessor(UserPhoneAccessor_NotEnoughParams.class);
  }

  @Test(groups = "short", expectedExceptions = RuntimeException.class)
  public void should_fail_if_too_many_parameters() {
    new MappingManager(session()).createAccessor(UserPhoneAccessor_TooManyParams.class);
  }

  /**
   * Ensures that a wrong parameter type is detected when the accessor is called with a wrong data
   * type.
   *
  ...
  public void should_fail_if_wrong_parameter_type() {
    UserPhoneAccessor_WrongParameterTypes accessor =
        new MappingManager(session()).createAccessor(UserPhoneAccessor_WrongParameterTypes.class);
  ...
  public interface UserPhoneAccessor {
    ...
    void updatePhones_named(
        @Param("key") int key, @Param("home") String homePhone, @Param("work") String workPhone);
